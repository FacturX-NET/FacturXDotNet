...
class CrossIndustryInvoiceParserImpl<T>
{
    ...
    public void RegisterValueHandler(string path, Action<T, ReadOnlyMemory<char>> handler)
    {
        ...
        {
            throw new CrossIndustryInvoiceParserInitializationException($"Duplicate handler for path: {path}.");
        }
    }
    ...
    public void RegisterFallbackValueHandler(Action<T, ReadOnlyMemory<char>, ReadOnlyMemory<char>> handler)
    {
        ...
        {
            throw new CrossIndustryInvoiceParserInitializationException("Duplicate fallback value handler.");
        }
    ...
    static CrossIndustryInvoiceParsingException CreateException(Exception exn, ReadOnlyMemory<char> callbackName) => new(callbackName.Span, exn);

    static CrossIndustryInvoiceParsingException CreateException(Exception exn, ReadOnlyMemory<char> callbackName, ReadOnlyMemory<char> value) =>
