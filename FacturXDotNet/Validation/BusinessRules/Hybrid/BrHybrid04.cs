...
/// <summary>
///     BR-HYBRID-04: The URI in the extension schema SHALL be urn:factur-x:pdfa:CrossIndustryDocument:1p0#.
/// </summary>
public record BrHybrid04() : HybridBusinessRule("BR-HYBRID-04", "The URI in the extension schema SHALL be urn:factur-x:pdfa:CrossIndustryDocument:1p0#.")
{
    /// <inheritdoc />
