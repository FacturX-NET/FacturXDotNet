...
export interface ExchangedDocumentContext {
   ...
   *
   * @ID BT-23
   * @CiiXpath /rsm:CrossIndustryInvoice/rsm:ExchangedDocumentContext/ram:BusinessProcessSpecifiedDocumentContextParameter/ram:ID
   * @Profile MINIMUM
   */
   ...
   *
   * @remarks This identifies compliance or conformance to the specification. Conformant invoices specify: urn:cen.eu:en16931:2017. Invoices, compliant to a user specification may identify
   * that user specification here. No identification scheme is to be used.
   *
   * @ID BT-24
   * @BR-1 An Invoice shall have a Specification identifier.
   * @CiiXpath /rsm:CrossIndustryInvoice/rsm:ExchangedDocumentContext/ram:GuidelineSpecifiedDocumentContextParameter/ram:ID
   * @Profile MINIMUM
   */
