...
export class StandardPdfGeneratorLanguagePackDto implements IStandardPdfGeneratorLanguagePackDto {
  ...
  sellerReferencesLabel?: string | undefined;
  invoicedObjectIdentifierLabel?: string | undefined;
  salesOrderReferenceLabel?: string | undefined;
  buyerReferencesLabel?: string | undefined;
  callForTenderLabel?: string | undefined;
  projectReferenceLabel?: string | undefined;
  accountingReferenceLabel?: string | undefined;
  contractReferenceLabel?: string | undefined;
  purchaseOrderReferenceLabel?: string | undefined;
  invoiceReferencesLabel?: string | undefined;
  startPeriodLabel?: string | undefined;
  endPeriodLabel?: string | undefined;
  precedingInvoiceReferenceLabel?: string | undefined;
  precedingInvoiceDateLabel?: string | undefined;
  ...
  buyerAddressLabel?: string | undefined;
  buyerIdentifiersLabel?: string | undefined;
  deliveryInformationLabel?: string | undefined;
  despatchAdviceLabel?: string | undefined;
  deliveryDateLabel?: string | undefined;
  receivingAdviceLabel?: string | undefined;
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.contactLabel = _data['contactLabel'];
      this.emailLabel = _data['emailLabel'];
      this.sellerReferencesLabel = _data['sellerReferencesLabel'];
      this.invoicedObjectIdentifierLabel = _data['invoicedObjectIdentifierLabel'];
      this.salesOrderReferenceLabel = _data['salesOrderReferenceLabel'];
      this.buyerReferencesLabel = _data['buyerReferencesLabel'];
      this.callForTenderLabel = _data['callForTenderLabel'];
      this.projectReferenceLabel = _data['projectReferenceLabel'];
      this.accountingReferenceLabel = _data['accountingReferenceLabel'];
      this.contractReferenceLabel = _data['contractReferenceLabel'];
      this.purchaseOrderReferenceLabel = _data['purchaseOrderReferenceLabel'];
      this.invoiceReferencesLabel = _data['invoiceReferencesLabel'];
      this.startPeriodLabel = _data['startPeriodLabel'];
      this.endPeriodLabel = _data['endPeriodLabel'];
      this.precedingInvoiceReferenceLabel = _data['precedingInvoiceReferenceLabel'];
      this.precedingInvoiceDateLabel = _data['precedingInvoiceDateLabel'];
      ...
      this.buyerAddressLabel = _data['buyerAddressLabel'];
      this.buyerIdentifiersLabel = _data['buyerIdentifiersLabel'];
      this.deliveryInformationLabel = _data['deliveryInformationLabel'];
      this.despatchAdviceLabel = _data['despatchAdviceLabel'];
      this.deliveryDateLabel = _data['deliveryDateLabel'];
      this.receivingAdviceLabel = _data['receivingAdviceLabel'];
  ...
  toJSON(data?: any) {
    ...
    data['contactLabel'] = this.contactLabel;
    data['emailLabel'] = this.emailLabel;
    data['sellerReferencesLabel'] = this.sellerReferencesLabel;
    data['invoicedObjectIdentifierLabel'] = this.invoicedObjectIdentifierLabel;
    data['salesOrderReferenceLabel'] = this.salesOrderReferenceLabel;
    data['buyerReferencesLabel'] = this.buyerReferencesLabel;
    data['callForTenderLabel'] = this.callForTenderLabel;
    data['projectReferenceLabel'] = this.projectReferenceLabel;
    data['accountingReferenceLabel'] = this.accountingReferenceLabel;
    data['contractReferenceLabel'] = this.contractReferenceLabel;
    data['purchaseOrderReferenceLabel'] = this.purchaseOrderReferenceLabel;
    data['invoiceReferencesLabel'] = this.invoiceReferencesLabel;
    data['startPeriodLabel'] = this.startPeriodLabel;
    data['endPeriodLabel'] = this.endPeriodLabel;
    data['precedingInvoiceReferenceLabel'] = this.precedingInvoiceReferenceLabel;
    data['precedingInvoiceDateLabel'] = this.precedingInvoiceDateLabel;
    ...
    data['buyerAddressLabel'] = this.buyerAddressLabel;
    data['buyerIdentifiersLabel'] = this.buyerIdentifiersLabel;
    data['deliveryInformationLabel'] = this.deliveryInformationLabel;
    data['despatchAdviceLabel'] = this.despatchAdviceLabel;
    data['deliveryDateLabel'] = this.deliveryDateLabel;
    data['receivingAdviceLabel'] = this.receivingAdviceLabel;
