...
export class EditorSettingsPdfProfileFormComponent {
  ...
  protected formGroup = new FormGroup({
    ...
    languagePack: new FormGroup({
      ...
      contactLabel: new FormControl<string | null>(null),
      emailLabel: new FormControl<string | null>(null),
      vatNumberLabel: new FormControl<string | null>(null),
      sellerReferencesLabel: new FormControl<string | null>(null),
      invoicedObjectIdentifierLabel: new FormControl<string | null>(null),
      salesOrderReferenceLabel: new FormControl<string | null>(null),
      buyerReferencesLabel: new FormControl<string | null>(null),
      callForTenderLabel: new FormControl<string | null>(null),
      projectReferenceLabel: new FormControl<string | null>(null),
      accountingReferenceLabel: new FormControl<string | null>(null),
      contractReferenceLabel: new FormControl<string | null>(null),
      purchaseOrderReferenceLabel: new FormControl<string | null>(null),
      invoiceReferencesLabel: new FormControl<string | null>(null),
      startPeriodLabel: new FormControl<string | null>(null),
      endPeriodLabel: new FormControl<string | null>(null),
      precedingInvoiceReferenceLabel: new FormControl<string | null>(null),
      precedingInvoiceDateLabel: new FormControl<string | null>(null),
      businessProcessLabel: new FormControl<string | null>(null),
      dateLabel: new FormControl<string | null>(null),
      buyerAddressLabel: new FormControl<string | null>(null),
      buyerIdentifiersLabel: new FormControl<string | null>(null),
      deliveryInformationLabel: new FormControl<string | null>(null),
      despatchAdviceLabel: new FormControl<string | null>(null),
      deliveryDateLabel: new FormControl<string | null>(null),
      receivingAdviceLabel: new FormControl<string | null>(null),
  ...
  getValue(): EditorPdfGenerationProfileData {
    ...
    return {
      ...
      languagePack: {
        ...
        contactLabel: this.formGroup.controls.languagePack.controls.contactLabel.value ?? undefined,
        emailLabel: this.formGroup.controls.languagePack.controls.emailLabel.value ?? undefined,
        vatNumberLabel: this.formGroup.controls.languagePack.controls.vatNumberLabel.value ?? undefined,
        sellerReferencesLabel: this.formGroup.controls.languagePack.controls.sellerReferencesLabel.value ?? undefined,
        invoicedObjectIdentifierLabel: this.formGroup.controls.languagePack.controls.invoicedObjectIdentifierLabel.value ?? undefined,
        salesOrderReferenceLabel: this.formGroup.controls.languagePack.controls.salesOrderReferenceLabel.value ?? undefined,
        buyerReferencesLabel: this.formGroup.controls.languagePack.controls.buyerReferencesLabel.value ?? undefined,
        callForTenderLabel: this.formGroup.controls.languagePack.controls.callForTenderLabel.value ?? undefined,
        projectReferenceLabel: this.formGroup.controls.languagePack.controls.projectReferenceLabel.value ?? undefined,
        accountingReferenceLabel: this.formGroup.controls.languagePack.controls.accountingReferenceLabel.value ?? undefined,
        contractReferenceLabel: this.formGroup.controls.languagePack.controls.contractReferenceLabel.value ?? undefined,
        purchaseOrderReferenceLabel: this.formGroup.controls.languagePack.controls.purchaseOrderReferenceLabel.value ?? undefined,
        invoiceReferencesLabel: this.formGroup.controls.languagePack.controls.invoiceReferencesLabel.value ?? undefined,
        startPeriodLabel: this.formGroup.controls.languagePack.controls.startPeriodLabel.value ?? undefined,
        endPeriodLabel: this.formGroup.controls.languagePack.controls.endPeriodLabel.value ?? undefined,
        precedingInvoiceReferenceLabel: this.formGroup.controls.languagePack.controls.precedingInvoiceReferenceLabel.value ?? undefined,
        precedingInvoiceDateLabel: this.formGroup.controls.languagePack.controls.precedingInvoiceDateLabel.value ?? undefined,
        ...
        buyerAddressLabel: this.formGroup.controls.languagePack.controls.buyerAddressLabel.value ?? undefined,
        buyerIdentifiersLabel: this.formGroup.controls.languagePack.controls.buyerIdentifiersLabel.value ?? undefined,
        deliveryInformationLabel: this.formGroup.controls.languagePack.controls.deliveryInformationLabel.value ?? undefined,
        despatchAdviceLabel: this.formGroup.controls.languagePack.controls.despatchAdviceLabel.value ?? undefined,
        deliveryDateLabel: this.formGroup.controls.languagePack.controls.deliveryDateLabel.value ?? undefined,
        receivingAdviceLabel: this.formGroup.controls.languagePack.controls.receivingAdviceLabel.value ?? undefined,
  ...
  setValue(profile: EditorPdfGenerationProfileData) {
    this.formGroup.setValue({
      ...
      languagePack: {
        ...
        contactLabel: profile.languagePack?.['contactLabel'] ?? null,
        emailLabel: profile.languagePack?.['emailLabel'] ?? null,
        vatNumberLabel: profile.languagePack?.['vatNumberLabel'] ?? null,
        sellerReferencesLabel: profile.languagePack?.['sellerReferencesLabel'] ?? null,
        invoicedObjectIdentifierLabel: profile.languagePack?.['invoicedObjectIdentifierLabel'] ?? null,
        salesOrderReferenceLabel: profile.languagePack?.['salesOrderReferenceLabel'] ?? null,
        buyerReferencesLabel: profile.languagePack?.['buyerReferencesLabel'] ?? null,
        callForTenderLabel: profile.languagePack?.['callForTenderLabel'] ?? null,
        projectReferenceLabel: profile.languagePack?.['projectReferenceLabel'] ?? null,
        accountingReferenceLabel: profile.languagePack?.['accountingReferenceLabel'] ?? null,
        contractReferenceLabel: profile.languagePack?.['contractReferenceLabel'] ?? null,
        purchaseOrderReferenceLabel: profile.languagePack?.['purchaseOrderReferenceLabel'] ?? null,
        invoiceReferencesLabel: profile.languagePack?.['invoiceReferencesLabel'] ?? null,
        startPeriodLabel: profile.languagePack?.['startPeriodLabel'] ?? null,
        endPeriodLabel: profile.languagePack?.['endPeriodLabel'] ?? null,
        precedingInvoiceReferenceLabel: profile.languagePack?.['precedingInvoiceReferenceLabel'] ?? null,
        precedingInvoiceDateLabel: profile.languagePack?.['precedingInvoiceDateLabel'] ?? null,
        businessProcessLabel: profile.languagePack?.['businessProcessLabel'] ?? null,
        dateLabel: profile.languagePack?.['dateLabel'] ?? null,
        buyerAddressLabel: profile.languagePack?.['buyerAddressLabel'] ?? null,
        buyerIdentifiersLabel: profile.languagePack?.['buyerIdentifiersLabel'] ?? null,
        deliveryInformationLabel: profile.languagePack?.['deliveryInformationLabel'] ?? null,
        despatchAdviceLabel: profile.languagePack?.['despatchAdviceLabel'] ?? null,
        deliveryDateLabel: profile.languagePack?.['deliveryDateLabel'] ?? null,
        receivingAdviceLabel: profile.languagePack?.['receivingAdviceLabel'] ?? null,
