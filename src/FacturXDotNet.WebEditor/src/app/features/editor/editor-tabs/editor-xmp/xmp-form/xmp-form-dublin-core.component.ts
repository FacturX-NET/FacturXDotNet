  ...
  template: `
    <div class="card" formGroupName="dublinCore">
      <div class="card-body">
        ...
        @if (!expanded()) {
          <button class="btn btn-link" (click)="expand()"><i class="bi bi-chevron-down"></i> More...</button>
        } @else {
          <div class="mb-3">
            ...
            <p id="dublinCoreContributorHelp" class="form-text">
              ...
              <span class="fw-semibold">DCMI comment</span>: Examples of a contributor include a person, an organization, or a service. Typically, the name of a contributor should
              be used to indicate the entity. <br />
          ...
          <div class="mb-3">
            ...
            <p id="dublinCoreFormatHelp" class="form-text">
              ...
              <span class="fw-semibold">DCMI comment</span>: Examples of dimensions include size and duration. Recommended best practice is to use a controlled vocabulary such as
              the list of Internet Media Types [MIME]. <br />
              <span class="fw-semibold">XMP addition</span>: XMP usage is a MIME type. Dimensions would be stored using a media-specific property, beyond the scope of this
              document.
              <br />
            </p>
          </div>
          ...
          <div class="mb-3">
            ...
            <p id="dublinCoreIdentifierHelp" class="form-text">
              ...
              <span class="fw-semibold">DCMI comment</span>: Recommended best practice is to identify the resource by means of a string conforming to a formal identification
              system.
              <br />
            </p>
          </div>
          ...
          <div class="mb-3">
            ...
            <p id="dublinCoreRelationHelp" class="form-text">
              ...
              <span class="fw-semibold">DCMI comment</span>: Recommended best practice is to identify the related resource by means of a string conforming to a formal
          ...
          <div class="mb-3">
            ...
            <p id="dublinCoreRightsHelp" class="form-text">
              ...
              <span class="fw-semibold">DCMI comment</span>: Typically, rights information includes a statement about various property rights associated with the resource,
          ...
          <div>
            ...
            <p id="dublinCoreTypeHelp" class="form-text">
              ...
              <span class="fw-semibold">DCMI comment</span>: Recommended best practice is to use a controlled vocabulary such as the DCMI Type Vocabulary [DCMITYPE]. To describe
              the file format, physical medium, or dimensions of the resource, use the dc:format element. <br />
              <span class="fw-semibold">XMP addition</span>: See the dc:format entry for clarification of the XMP usage of that element. <br />
            </p>
          </div>

          <button class="btn btn-link" (click)="fold()"><i class="bi bi-chevron-up"></i> Less...</button>
        }
      </div>
    </div>
  `,
