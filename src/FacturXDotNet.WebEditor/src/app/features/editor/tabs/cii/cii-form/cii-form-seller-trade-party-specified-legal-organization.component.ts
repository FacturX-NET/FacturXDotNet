...
@Component({
  ...
  template: `
    <div [formGroupName]="formGroupName()">
      <div class="row">
        <div class="col">
          <app-cii-form-control [term]="bt30" [description]="bt30Description" [businessRules]="[{ id: 'BR-CO-26', template: brCo26 }]" [settings]="settings()" #bt30Control>
        ...
        <div class="col">
          <div class="mb-3">
            <app-cii-form-control [term]="bt301" [description]="bt301Description" [remarks]="[bt301remark]" [settings]="settings()" #bt301Control>
