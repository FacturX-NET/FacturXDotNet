...
@Component({
  ...
  template: `
    <div class="card" formGroupName="basic">
      <div class="card-body">
        <h4 id="basic" class="card-title">Basic XMP metadata</h4>
        <p class="card-text">The XMP basic namespace contains properties that provide basic descriptive information.</p>
        ...
        <div class="mb-3">
          ...
          <input id="basicCreateDate" class="editor__control form-control" formControlName="createDate" type="date" aria-describedby="basicCreateDateHelp" />
        ...
        <div class="mb-3">
          ...
          <input id="basicMetadataDate" class="editor__control form-control" formControlName="metadataDate" type="date" aria-describedby="basicMetadataDateHelp" />
        ...
        <div class="mb-3">
          ...
          <input id="basicModifyDate" class="editor__control form-control" formControlName="modifyDate" type="date" aria-describedby="basicModifyDateHelp" />
