...
/// </summary>
public record BrHybrid15() : HybridBusinessRule("BR-HYBRID-15", "The fx:ConformanceLevel SHOULD match the profile of the embedded XML document.", BusinessRuleSeverity.Warning)
{
    /// <inheritdoc />
