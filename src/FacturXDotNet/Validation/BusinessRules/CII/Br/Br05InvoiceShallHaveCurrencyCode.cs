...
public record Br05InvoiceShallHaveCurrencyCode() : CrossIndustryInvoiceBusinessRule(
    ...
    [
        $"{nameof(CrossIndustryInvoice.SupplyChainTradeTransaction)}.{nameof(SupplyChainTradeTransaction.ApplicableHeaderTradeSettlement)}.{nameof(ApplicableHeaderTradeSettlement.InvoiceCurrencyCode)}"
    ]
)
{
    /// <inheritdoc />
