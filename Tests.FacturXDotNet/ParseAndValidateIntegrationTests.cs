...
public class ParseAndValidateIntegrationTests
{
    ...
    [DataRow("TestFiles/FacturX/1.BASIC WL/Facture_F20220023-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC WL.pdf", FacturXProfileFlags.BasicWl)]
    [DataRow("TestFiles/FacturX/1.BASIC WL/Facture_F20220024-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC WL.pdf", FacturXProfileFlags.BasicWl)]
    [DataRow("TestFiles/FacturX/1.BASIC WL/Facture_F20220025-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC WL.pdf", FacturXProfileFlags.BasicWl)]
    [DataRow("TestFiles/FacturX/1.BASIC WL/Facture_F20220026-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC WL.pdf", FacturXProfileFlags.BasicWl)]
    [DataRow("TestFiles/FacturX/1.BASIC WL/Facture_F20220027-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC WL.pdf", FacturXProfileFlags.BasicWl)]
    [DataRow("TestFiles/FacturX/1.BASIC WL/Facture_F20220028-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC WL.pdf", FacturXProfileFlags.BasicWl)]
    [DataRow("TestFiles/FacturX/1.BASIC WL/Facture_F20220029-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC WL.pdf", FacturXProfileFlags.BasicWl)]
    [DataRow("TestFiles/FacturX/1.BASIC WL/Facture_F20220030-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC WL.pdf", FacturXProfileFlags.BasicWl)]
    [DataRow("TestFiles/FacturX/1.BASIC WL/Facture_F20220031-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC WL.pdf", FacturXProfileFlags.BasicWl)]
    [DataRow("TestFiles/FacturX/1.BASIC WL/Facture_UC1_2023020_AFF-LE_FOURNISSEUR-POUR-L'ACHETEUR_BASIC WL.pdf", FacturXProfileFlags.BasicWl)]
    [DataRow("TestFiles/FacturX/1.BASIC WL/Facture_UC1_2023025_F-LE_FOURNISSEUR-POUR-L'ACHETEUR_BASIC WL.pdf", FacturXProfileFlags.BasicWl)]
    ...
    [DataRow("TestFiles/FacturX/3.EN16931/Facture_F20220023-LE_FOURNISSEUR-POUR-LE_CLIENT_EN16931.pdf", FacturXProfileFlags.En16931)]
    [DataRow("TestFiles/FacturX/3.EN16931/Facture_F20220024-LE_FOURNISSEUR-POUR-LE_CLIENT_EN16931.pdf", FacturXProfileFlags.En16931)]
    [DataRow("TestFiles/FacturX/3.EN16931/Facture_F20220025-LE_FOURNISSEUR-POUR-LE_CLIENT_EN16931.pdf", FacturXProfileFlags.En16931)]
    [DataRow("TestFiles/FacturX/3.EN16931/Facture_F20220026-LE_FOURNISSEUR-POUR-LE_CLIENT_EN16931.pdf", FacturXProfileFlags.En16931)]
    [DataRow("TestFiles/FacturX/3.EN16931/Facture_F20220027-LE_FOURNISSEUR-POUR-LE_CLIENT_EN16931.pdf", FacturXProfileFlags.En16931)]
    [DataRow("TestFiles/FacturX/3.EN16931/Facture_F20220028-LE_FOURNISSEUR-POUR-LE_CLIENT_EN16931.pdf", FacturXProfileFlags.En16931)]
    [DataRow("TestFiles/FacturX/3.EN16931/Facture_F20220029-LE_FOURNISSEUR-POUR-LE_CLIENT_EN16931.pdf", FacturXProfileFlags.En16931)]
    [DataRow("TestFiles/FacturX/3.EN16931/Facture_F20220030-LE_FOURNISSEUR-POUR-LE_CLIENT_EN16931.pdf", FacturXProfileFlags.En16931)]
    [DataRow("TestFiles/FacturX/3.EN16931/Facture_F20220031-LE_FOURNISSEUR-POUR-LE_CLIENT_EN16931.pdf", FacturXProfileFlags.En16931)]
    [DataRow("TestFiles/FacturX/3.EN16931/Facture_UC1_2023020_AFF-LE_FOURNISSEUR-POUR-L'ACHETEUR_EN16931.pdf", FacturXProfileFlags.En16931)]
    [DataRow("TestFiles/FacturX/3.EN16931/Facture_UC1_2023025_F-LE_FOURNISSEUR-POUR-L'ACHETEUR_EN16931.pdf", FacturXProfileFlags.En16931)]
